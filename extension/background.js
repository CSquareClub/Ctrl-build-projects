...
function connectSocket() {
  ...
  if (tabs.length > 0) {
    chrome.tabs.update(tabs[0].id, { url: "http://localhost:5173/analytics" });
  }
});
    ...
    if (data.reason === 'phone_kill') {
      chrome.notifications.create('phone_kill', {
        type: 'basic',
        iconUrl: 'icons/icon48.png',
        title: '🚨 DISTRACTION DETECTED! 🚨',
        message: 'You kept your phone out for too long. Focus Session TERMINATED.',
        priority: 2
      });
    } else {
