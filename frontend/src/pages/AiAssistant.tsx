          ...
          <aside className="space-y-4">
            ...
            <div className="rounded-3xl border border-[var(--border)] bg-[var(--card)] p-4">
              ...
              <p className="mt-2 text-sm text-[var(--muted)]">
                Set <span className="font-medium text-[var(--text)]">VITE_OPENAI_API_KEY</span> in your local environment, then ask for study plans, explanations, or flashcards. Responses are generated by OpenAI.
              </p>
            </div>
          </aside>
        </section>
